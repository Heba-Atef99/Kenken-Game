...
from board_gui import create_board
...
def get_input():
    ...
    # elif int(board_size) < 3:
    #     messagebox.showwarning("Warning", "The minimum number for board size is 3")

    # else:
    #     solution = 0
    #     create_board(window, board_size, solution)
    s = 0
    create_board(window, board_size, s)
